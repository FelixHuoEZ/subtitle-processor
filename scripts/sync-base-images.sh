...
NAS_PATH_PREFIX="${NAS_PATH_PREFIX:-/usr/local/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin}"
DRY_RUN=false
VERIFY_ONLY=false
IMAGES=()
...
Environment:
  BASE_IMAGE_REGISTRY Mirror prefix, e.g. registry.example.com:5443/dockerhub
